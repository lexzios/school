...
/**
 * @ngdoc function
 * @name lspr.attendance.controller:DetailLeaveController
 * @description
 * # DetailLeaveController
 * Controller of the Detail Leave component
 */
lspr.attendance.controller('DetailLeaveController', DetailLeaveController);

function DetailLeaveController ($log, $scope, $rootScope, $filter, lsprNav) {

	var vm = this;

	$log.info('Inside Detail Leave Controller');
...
DetailLeaveController.$inject = ['$log', '$scope', '$rootScope', '$filter', 'lsprNav'];
