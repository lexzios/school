...
/**
 * @ngdoc function
 * @name lspr.training.controller:TrainingScholarshipPaymentDetailController
 * @description
 * # TrainingScholarshipPaymentDetailController
 * Controller of the Edit Training Scholarship Payment Detail component
 */
lspr.training.controller('TrainingScholarshipPaymentDetailController', TrainingScholarshipPaymentDetailController);

function TrainingScholarshipPaymentDetailController ($log, $scope, $rootScope, $filter, lsprNav) {
...
TrainingScholarshipPaymentDetailController.$inject = ['$log', '$scope', '$rootScope', '$filter', 'lsprNav'];
